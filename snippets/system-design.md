# system-design debugging notes

## Common failure modes

1. **Connection refused**: Usually means the system-design server isn't running or port is wrong
...
```bash
# replace with actual system-design commands
echo "1. Check if system-design is reachable"

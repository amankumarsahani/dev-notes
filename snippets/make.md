# make debugging notes

## Common failure modes

1. **Connection refused**: Usually means the make server isn't running or port is wrong
...
```bash
# replace with actual make commands
echo "1. Check if make is reachable"
